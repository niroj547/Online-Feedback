...
$stmt = $conn->prepare("
    SELECT f.student_name AS student_name, 
           f.lecturer_rating, 
           f.tutor_rating, 
           f.comment, 
           c.name AS course 
...
<body class="p-4">
  ...
  <p><strong>Lecturer Rating:</strong> <?= $feedback['lecturer_rating'] ?? 'N/A' ?></p>
  <p><strong>Tutor Rating:</strong> <?= $feedback['tutor_rating'] ?? 'N/A' ?></p>
